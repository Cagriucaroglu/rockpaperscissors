...
public class Makas extends Nesne {
          ...
          public String nesnePuaniGoster(ArrayList<Nesne> nesneler, int index, double etki, double eski_dayaniklilik_user) {
                    ...
                    String text;
                    text = "<html>&ensp;&emsp;&emsp;&emsp;&nbsp;MAKAS<br/>&emsp;&emsp;Seviye Puanı: " + nesneler.get(index).seviyePuani
          ...
          public void durumGuncelle(double etki, double etki2, ArrayList<Nesne> List, int index) {
                    ...
                    if (etki > etki2) {
                              ...
                              if (seviyePuani > 30) {
                                        Usta_Makas usta_Makas = new Usta_Makas(dayaniklilik, seviyePuani, 2, 2);
                                        List.set(index, usta_Makas);
                              }
                    }
          }
